...
class Requerimiento2 extends AnyFlatSpec {
  val vikingo1: Vikingo = Vikingo(velocidad = 100, peso = 100, barbarosidad = 50, porcentajeHambre = 60, item = Option(new Arma(nombre = "espada suprema", danio = 1000)))
  val vikingoQueProduceMuchoDanio: Vikingo = Vikingo(velocidad = 100, peso = 100, barbarosidad = 50, porcentajeHambre = 20, item = Option(new Arma(nombre = "espada suprema", danio = 1000000)))
  val vikingoQueProducePocoDanio: Vikingo = Vikingo(velocidad = 100, peso = 100, barbarosidad = 50, porcentajeHambre = 20, item = Option(new Arma(nombre = "espada suprema", danio = 1)))
  val combate: Combate = Combate(hambre = 50, requisito = new RequisitoItem(i => i.isInstanceOf[Arma] && i.nombre == "espada suprema"))
