...
class Requerimiento1 extends AnyFlatSpec with Matchers {
  val vikingo: Vikingo = new Vikingo(velocidad = 100, peso = 100, barbarosidad = 50, porcentajeHambre = 20, item = Some(new Arma(nombre = "espada suprema", danio = 1000)))
  ...
  "jineteExitoso" should "retorna un jinete si el montado fue exitoso" in {
    ...
    jineteExitoso shouldBe a [Success[_]]
  }
  ...
  "jineteNoExitoso" should "retorna un failure si el montado no fue exitoso" in {
    ...
    jineteNoExitoso shouldBe a [Failure[_]]
  }
}
